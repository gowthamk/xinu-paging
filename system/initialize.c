...
/* For paging */
unsigned long tmp;
char* pf_test_ptr = (char *)0x80000000;

void test_paging() {
    char* p = pf_test_ptr;
    asm("movl %eax, 0x80000000");
    //kprintf("Value at 0x%08X is %d\n",p,*p);
    return;
}
